...
- 2026-08-03 — Os 3 depoimentos do site antigo **ficaram**, por pedido do usuário ("pode manter esses também"), convivendo com os 4 do Google. Procedência mista funciona porque o `fonte` de cada item controla a marca: só `"google"` recebe o "G" e as estrelas. Consequência: `resumo.fonteLabel` voltou de "Avaliações no Google" para **"Nota no Google"** — plural colado no logo do Google sugeriria que os sete cartões vieram de lá.
