...
- 2026-08-13 — **A órbita virou ELIPSE**, a pedido do usuário ("aumentar o espaçamento de cada um, faça proporcional ao tamanho da seção, tem muito espaço"), e é um raio por eixo em vez de um só. Círculo aqui significa raio = o menor dos dois eixos: o palco tem ~1120×710, então ele ficava preso nos 710 da altura e sobravam ~250px de vazio de cada lado. Raio horizontal de 272 para **430**, vertical mantido em ~236.
...
- 2026-08-13 — **O tamanho do retrato da órbita é CALCULADO, não escolhido**, e foram duas rodadas de "aumentar os cards" para chegar nisso: um número que cabe em 1440 colide em 1280 (10px) e em 1024 (46px). O componente testa candidatos de 176px para baixo e fica com o maior que passa no teste de colisão de todos os pares vizinhos — duas caixas só se cruzam se AMBOS os eixos se cruzam. Resultado: 168px em 1440, 176 em 1920, 148 em 1280, 116 em 1024, e zero sobreposição nos quatro. O teto geométrico é `0,293·raioX`, o vão entre a peça diagonal e a lateral.
- 2026-08-13 — Para o retrato caber em 168px, **a órbita saiu do container de 1200px e ocupa a largura do BLOCO** (1408px em 1440), com margem negativa de `2,5rem + max(0px, 50vw - 616px)`. Preso no container, o teto era ~128px. Foi o que atendeu "aproveite mais os espaços".
